...
class Bzotech_Multi_Language_Global extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Multi language (Global)', 'bw-kidxtore' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'wpml-style' => esc_html__( 'Style by Wpml', 'bw-kidxtore' ),
					'poly-style' => esc_html__( 'Style by Polylang', 'bw-kidxtore' ),
					'demo-style' => esc_html__( 'Demo style', 'bw-kidxtore' ),
				],
			]
		);
		...
		$data_demo->add_control(
			'image', [
				...
				'placeholder' => esc_html__( 'Enter logo flag', 'bw-kidxtore' ),
			]
		);
		$this->add_control(
			'data_demo',
			[
				...
				'default' => [
					[
						'title' => esc_html__( 'English', 'bw-kidxtore' ),
					],
					[
						'title' => esc_html__( 'Viet Nam', 'bw-kidxtore' ),
					],
				],
				'title_field' => '{{{ title }}}',
				'condition' => [
		...
		$this->add_control(
			'flag',
			[
				'label' => esc_html__( 'Show Flag', 'bw-kidxtore' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Yes', 'bw-kidxtore' ),
				'label_off' => esc_html__( 'No', 'bw-kidxtore' ),
				'return_value' => 'yes',
				'default' => 'yes',
				'condition' => [
		...
		$this->add_control(
			'show_label',
			[
				'label' => esc_html__( 'Show Label', 'bw-kidxtore' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Yes', 'bw-kidxtore' ),
				'label_off' => esc_html__( 'No', 'bw-kidxtore' ),
				'return_value' => 'yes',
		...
		$this->start_controls_section(
			'section_style_label',
			[
				'label' => esc_html__( 'Label style', 'bw-kidxtore' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Label item style', 'bw-kidxtore' ),
				'tab'   => Controls_Manager::TAB_STYLE,
				'condition' => [
					'style' =>  ['default','demo-style'],
				]
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Dropdown style', 'bw-kidxtore' ),
				'tab'   => Controls_Manager::TAB_STYLE,
				'condition' => [
					'style' =>  ['default','demo-style'],
				]
