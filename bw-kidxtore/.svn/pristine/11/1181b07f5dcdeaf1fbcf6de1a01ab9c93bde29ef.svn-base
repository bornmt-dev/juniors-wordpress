	...
	if(!empty($icon_image['url'])){
		...
		echo '<div class="info-box-icon item-image-icon-e '.$class_icon_image_hover.' elementor-animation-'.$image_icon_animation_hover_css.'">';
			echo  '<a '.$wdata->get_render_attribute_string( 'link_icon' ).'>';
				echo '<div class="image_icon">';
					echo Group_Control_Image_Size::get_attachment_image_html( $settings,'image_icon','icon_image');
				echo '</div>';
				if(!empty($icon_image_hover['url'])){
					echo '<div class="image_icon_hover">';
						echo Group_Control_Image_Size::get_attachment_image_html( $settings,'image_icon','icon_image_hover');
					echo '</div>';
				}
		...
		if( $icon['library'] == 'svg')
			echo '<div class="info-box-icon item-image-icon-e elementor-animation-'.$image_icon_animation_hover_css.'"><a '.$wdata->get_render_attribute_string( 'link_icon' ).'><img class="item-icon-e" alt="'.esc_attr__('svg','bw-kidxtore').'" src="'.$icon['value']['url'].'"></a></div>';
		else
