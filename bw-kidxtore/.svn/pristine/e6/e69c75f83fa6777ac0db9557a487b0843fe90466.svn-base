...
class Bzotech_Course_Global extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Course (Global)', 'bw-kidxtore' );
	}
	...
	public function get_slider_settings() {
		...
		$this->add_control(
			'slider_auto',
			[
				'label' => esc_html__( 'Auto play', 'bw-kidxtore' ),
		...
		$this->add_control(
			...
			[
				...
				'options'   => [
					...
					'style2'		=> esc_html__( 'Style 2 (Vertical)', 'bw-kidxtore' ),
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options'   => [
					'elbzotech-post-grid'		=> esc_html__( 'Default (Grid)', 'bw-kidxtore' ),
					'elbzotech-post-slider'		=> esc_html__( 'Slider', 'bw-kidxtore' ),
				],
			]
		);
		...
		$this->add_control(
			'type_active',
			[
				'label' 	=> esc_html__( 'Active type', 'bw-kidxtore' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'grid',
				'options'   => [
		...
		$this->start_controls_section(
			'section_grid',
			[
				'label' => esc_html__( 'Grid', 'bw-kidxtore' ),
				'tab' => Controls_Manager::TAB_CONTENT,
				'condition' => [
		...
		$this->add_control(
			'item_style',
			[
				'label' 	=> esc_html__( 'Item style', 'bw-kidxtore' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => '',
				'options'   =>[
		...
		$this->add_control(
			...
			[
				...
				'options'   => [
					...
					'grid-custom'	=> esc_html__( 'Grid custom', 'bw-kidxtore' ),
				],
				'condition' => [
					'display' => 'elbzotech-post-grid',
				]
		...
		$repeater_grid_custom->add_responsive_control(
			'col_grid', 
			[
				'label' => esc_html__( 'Column grid', 'bw-kidxtore' ),
				'default' => esc_html__( 'Enter number column' , 'bw-kidxtore' ),
				'label_block' => true,
				'type' => Controls_Manager::SELECT,
				'options' => [
					'1'  => esc_html__( '1', 'bw-kidxtore' ),
					'2' => esc_html__( '2', 'bw-kidxtore' ),
					'3' => esc_html__( '3', 'bw-kidxtore' ),
					'4' => esc_html__( '4', 'bw-kidxtore' ),
					'5' => esc_html__( '5', 'bw-kidxtore' ),
					'6' => esc_html__( '6', 'bw-kidxtore' ),
					'7' => esc_html__( '7', 'bw-kidxtore' ),
					'8' => esc_html__( '8', 'bw-kidxtore' ),
					'9' => esc_html__( '9', 'bw-kidxtore' ),
		...
		$repeater_grid_custom->add_responsive_control(
			'row_grid', 
			[
				'label' => esc_html__( 'Row grid', 'bw-kidxtore' ),
				'default' => esc_html__( 'Enter number row' , 'bw-kidxtore' ),
				'label_block' => true,
				'type' => Controls_Manager::SELECT,
				'options' => [
					'1'  => esc_html__( '1', 'bw-kidxtore' ),
		...
		$this->add_control(
			'list_grid_custom',
			[
				'label' => esc_html__( 'Add column row', 'bw-kidxtore' ),
		...
		$this->start_controls_section(
			'section_list',
			[
				'label' => esc_html__( 'List', 'bw-kidxtore' ),
				'tab' => Controls_Manager::TAB_CONTENT,
				'condition' => [
					'display' => 'elbzotech-post-grid',
				]
		...
		$this->add_control(
			...
			[
				...
				'options'   => [
					...
					'style3'		=> esc_html__( 'Style 3 - menu', 'bw-kidxtore' ),					
		...
		$this->add_control(
			'item_meta_list',
			[
				'label' => esc_html__( 'Meta data', 'bw-kidxtore' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'On', 'bw-kidxtore' ),
				'label_off' => esc_html__( 'Off', 'bw-kidxtore' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			...
			[
				'label' 	=> esc_html__( 'Meta', 'bw-kidxtore' ),
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .item-post' => 'width: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .list-col-item' => 'width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
		...
		$this->add_responsive_control(
			'meta_space',
			[
				'label' => esc_html__( 'Space meta item', 'bw-kidxtore' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => -300,
		...
		$this->add_responsive_control(
			'meta_icon_space',
			[
				'label' => esc_html__( 'Space icon', 'bw-kidxtore' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => -300,
		...
		$this->add_responsive_control(
			'meta_bottom_space',
			[
				'label' => esc_html__( 'Space bottom', 'bw-kidxtore' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => -300,
	...
	protected function render() {
		if (!class_exists('Bzotech_CoursesController') ) return;
		...
		if ( $view == 'slider' ) {
			...
			$this->add_render_attribute( 'elbzotech-wrapper', 'class', 'elbzotech-posts-wrap js-content-wrap ' );
        ...
        bzotech_get_template_elementor_global('course/'.$view,'',$attr,true);
        wp_reset_postdata();
	}
