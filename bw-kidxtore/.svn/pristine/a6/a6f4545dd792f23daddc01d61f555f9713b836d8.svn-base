...
class Bzotech_Menu_Global extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Menu (Global)', 'bw-kidxtore' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
            'content_tab',
            [
                'label' => esc_html__('Menu settings', 'bw-kidxtore'),
        ...
        $this->add_control(
            'nav_menu',
            [
                'label'     =>esc_html__( 'Select menu', 'bw-kidxtore' ),
		...
		$this->add_control(
			'main_menu_style',
			[
				'label' => esc_html__( 'Menu style', 'bw-kidxtore' ),
				'type' => Controls_Manager::SELECT,
				'default' => '',
				'options' => [
					''  => esc_html__( 'Default', 'bw-kidxtore' ),
					'icon' => esc_html__( 'Menu icon', 'bw-kidxtore' ),
				],
			]
		);
		$this->add_control(
			'menu_sticky',
			[
				'label' => esc_html__( 'Menu sticky', 'bw-kidxtore' ),
		...
		$this->add_control(
			'megamenu_max_width',
			[
				'label' => esc_html__( 'Mega menu max width', 'bw-kidxtore' ),
				'type' => Controls_Manager::NUMBER,
				'min' => 1,
				'max' => 2000,
				'step' => 1,
				'default' => '',
				'description' => esc_html__( 'This index is used to determine the maximum width of the mega menu. Default is equal to container: 1440px', 'bw-kidxtore' ),
			]
		);
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Menu position content', 'bw-kidxtore' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'left',
				'options' => [
		 ...
		 $this->add_control(
			...
			[
				'label' => esc_html__( 'Menu icon title ', 'bw-kidxtore' ),
		...
		$this->add_control(
			'menu_mobile_style',
			[
				'label' => esc_html__( 'Display menu style on mobile', 'bw-kidxtore' ),
				'type' => Controls_Manager::SELECT,
				'default' => '',
				'options' => [
					''  => esc_html__( 'Default dropdown type', 'bw-kidxtore' ),
					'left'  => esc_html__( 'Side Left', 'bw-kidxtore' ),
                    'right' => esc_html__( 'Side Right', 'bw-kidxtore' ),
				],
				'label_block' => true,
				'condition' => [
					'main_menu_style' => '',
		...
		$this->start_controls_section(
            'content_side_tab',
            [
                'label' => esc_html__('Menu side/mobile', 'bw-kidxtore'),
                'tab' => Controls_Manager::TAB_CONTENT,
            ]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Choose Mobile Menu Logo', 'bw-kidxtore' ),
		...
		$this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Item text color', 'bw-kidxtore' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Head Padding', 'bw-kidxtore' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
        ...
        $this->start_controls_section(
            'style_tab_menuitem',
            [
                'label' => esc_html__('Menu item style', 'bw-kidxtore'),
        ...
        $this->add_responsive_control(
			'menu_item_spacing',
			[
				'label' => esc_html__( 'Spacing', 'bw-kidxtore' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px' ],
				'selectors' => [
		...
		$this->start_controls_tabs(
			...
			$this->add_group_control(
				...
				[
					...
					'label' => esc_html__( 'Item background', 'bw-kidxtore' ),
					'types' => ['classic', 'gradient'],
					'selector' => '{{WRAPPER}} .bzotech-navbar-nav > li > a',
				]
			);
			...
			$this->add_responsive_control(
				...
				[
					'label' => esc_html__( 'Item text color (Active)', 'bw-kidxtore' ),
					'type' => Controls_Manager::COLOR,
					'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Items Border', 'bw-kidxtore' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Border Last Child', 'bw-kidxtore' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Border First Child', 'bw-kidxtore' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			'style_effect_hover',
			[
				'label' => esc_html__( 'Effect hover style', 'bw-kidxtore' ),
				'type' => Controls_Manager::SELECT,
				'default' => '',
				'options' => [
					''  => esc_html__( 'None', 'bw-kidxtore' ),
					'effect-line-bottom'  => esc_html__( 'Line bottom', 'bw-kidxtore' ),
					'effect-line-top' => esc_html__( 'Line top', 'bw-kidxtore' ),
				],
				'separator' => 'before',
			]
		);
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Background Line', 'bw-kidxtore' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Height Line', 'bw-kidxtore' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Submenu item style', 'bw-kidxtore'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Submenu Indicator', 'bw-kidxtore' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'bzotech_line_arrow',
				'options' => [
					'bzotech_line_arrow'  => esc_html__( 'Line Arrow', 'bw-kidxtore' ),
					'bzotech_plus_icon' => esc_html__( 'Plus', 'bw-kidxtore' ),
					'bzotech_fill_arrow' => esc_html__( 'Fill Arrow', 'bw-kidxtore' ),
					'bzotech_none' => esc_html__( 'None', 'bw-kidxtore' ),
                ],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Indicator color', 'bw-kidxtore' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Indicator Margin', 'bw-kidxtore' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
		...
		$this->start_controls_tabs(
			...
			$this->add_responsive_control(
				...
				[
					'label' => esc_html__( 'Item text color (hover)', 'bw-kidxtore' ),
					'type' => Controls_Manager::COLOR,
					'selectors' => [
			...
			$this->add_group_control(
				...
				[
					...
					'label' => esc_html__( 'Item background (hover)', 'bw-kidxtore' ),
					'types' => [ 'classic', 'gradient' ],
					'selector' => '
			...
			$this->add_group_control(
				...
				[
					...
					'label' 	=> esc_html__( 'Item background (Active)', 'bw-kidxtore' ),
					'types'		=> ['classic', 'gradient'],
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Sub Menu Items Border', 'bw-kidxtore' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Submenu panel style', 'bw-kidxtore'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Panel Menu Border', 'bw-kidxtore' ),
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__( 'Container background', 'bw-kidxtore' ),
                'types' => [ 'classic','gradient' ],
                'selector' => '{{WRAPPER}} .bzotech-navbar-nav .sub-menu',
            ]
        );
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Container width', 'bw-kidxtore' ),
                'type' => Controls_Manager::TEXT,
                'selectors' => [
        ...
        $this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Icon menu Style', 'bw-kidxtore' ),
                'tab' => Controls_Manager::TAB_STYLE,
			]
		);
        $this->get_style_type_container_flex('menu_toggle_style_flex','e-toggle-style-flex');
        $this->get_style_type_text('menu_toggle_style_menu_icon','e-toggle-style-flex');
        $this->add_control(
			'heading_menu_toggle_style_icon',
			[
				'label' => esc_html__( 'Style icon', 'bw-kidxtore' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Style title icon', 'bw-kidxtore' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
        ...
        /*$this->add_control(
			...
			[
				'label' => esc_html__( 'Icon menu Toggle', 'bw-kidxtore' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'options' => [
					'left' => [
						'title' => esc_html__( 'Top', 'bw-kidxtore' ),
						'icon' => 'fa fa-angle-left',
					],
					'right' => [
						'title' => esc_html__( 'Middle', 'bw-kidxtore' ),
        ...
        $this->add_responsive_control(
			'menu_toggle_size',
			[
				'label' => esc_html__( 'Size', 'bw-kidxtore' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
				...
				'selectors' => [
					'{{WRAPPER}} .toggler-icon .bzotech-menu-toggler' => 'width: {{SIZE}}{{UNIT}};',
				],
			]
        );
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Size height', 'bw-kidxtore' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Humber Icon Color', 'bw-kidxtore' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
...
*/
       ...
       /* $this->add_control(
			...
			[
				'label' => esc_html__( 'Close Toggle', 'bw-kidxtore' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Mobile Menu Logo', 'bw-kidxtore' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
