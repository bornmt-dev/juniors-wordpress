...
class Bzotech_Breadcrumb_Global extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Breadcrumb (Global)', 'bw-kidxtore' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'section_item_style',
			[
				'label' => esc_html__( 'Style item breadcrumb', 'bw-kidxtore' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);

		$this->get_style_type_text('item_breadcrumb','bread-crumb-e, {{WRAPPER}} a');
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Style item breadcrumb last child', 'bw-kidxtore' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
