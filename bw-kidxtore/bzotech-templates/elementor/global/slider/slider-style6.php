                ...
                echo '<div '.$wdata->get_render_attribute_string( 'elbzotech-item-slider-'.$style.'-'.$key ).'><div class="item-slider-global-'.$style.'">';
                    ...
                    if(!empty($item['content'])){
                     ...
                     if(!empty($item['image']['url'])){
                        $image_html = '<span class="image-cate">'.wp_get_attachment_image( $item['image']['id'] ,'full').'</span>';
                    ...
                    if(!empty($item['template'])) 
                       ...
                       echo '<div class="cate-img"><a class="adv-thumb-link-cate adv-thumb-link" '.$link_html.'>'.$image_html.'</a></div>
