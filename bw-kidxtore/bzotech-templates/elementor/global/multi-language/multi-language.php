    ...
    case 'demo-style':
       if(!empty($data_demo)){
            ...
            foreach($data_demo as $key => $value){
                 if($key == 0){
                    $l_class = 'active';
                    $lang_active = '<a class="dropdown-link label-e '.bzotech_implode($css_by_theme_text).'" href="#'.$value['_id'].'">';
        ...
        if(defined('ICL_SITEPRESS_VERSION') && defined('ICL_LANGUAGE_CODE') ){
            ...
            foreach ($wpml_lang as $lang) {
                ...
                if($lang['active']){
                    ...
                    if($flag == 'yes') $lang_active .=  '<img alt="'.esc_attr__("flag",'bw-kidxtore').'" src="'.esc_url($flag_url).'">';
                ...
                if($flag == 'yes') $lang_sub .=     '<img alt="'.esc_attr__("flag",'bw-kidxtore').'" src="'.esc_url($flag_url).'">';
