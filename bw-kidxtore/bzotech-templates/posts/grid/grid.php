...
<?php echo '<div '.$item_inner.'>';?>
        ...
        <div class="post-info">
            ...
            <?php if($item_title == 'yes'):?><h3 class="title18 post-title font-medium"><a class="color-title" href="<?php echo esc_url(get_the_permalink()) ?>"><?php the_title()?></a></h3><?php endif ?>
