...
else $title = esc_html__("Blog",'bw-kidxtore');
...
if(is_single()) $title = esc_html__("Blog",'bw-kidxtore');
if(is_singular('product')) $title = esc_html__("Product",'bw-kidxtore');
if(is_search()) $title = esc_html__("Search Result",'bw-kidxtore');
