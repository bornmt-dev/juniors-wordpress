                            ...
                            <div class="comments-tab-product-accordion__header align_items-center flex-wrapper flex_wrap-wrap justify_content-space-between align_items-flex-start">
                                <div class="woocommerce-product-rating flex-wrapper flex_wrap-wrap align_items-center total-star">
                                    ...
                                    <?php if ( comments_open() ) : ?>
                                        <?php //phpcs:disable ?>
                                        <a href="#reviews" class="woocommerce-review-link" rel="nofollow">(<?php printf( _n( '%s customer review', '%s customer reviews', $review_count, 'bw-kidxtore' ), '<span class="count">' . esc_html( $review_count ) . '</span>' ); ?>)</a>
                                        <?php // phpcs:enable ?>
                                    <?php endif ?>
                                </div>
                                <div><a class="elbzotech-bt-default write-a-review"><?php echo bzotech_get_icon_svg('edit'); echo esc_html__('Write A Review','bw-kidxtore'); ?></a></div>
                            </div>
                    ...
                    <ul class="list-none" role="tablist">
                        ...
                        foreach ( $tabs as $key => $tab ) :
                            ...
                            <li class="<?php echo esc_attr($active)?> <?php echo esc_attr( $key ); ?>_tab" id="tab-title-<?php echo esc_attr( $key ); ?>">
                                <a class="title20 font-regular text-uppercase" href="#tab-<?php echo esc_attr( $key ); ?>" data-target="#tab-<?php echo esc_attr( $key ); ?>" data-toggle="tab" aria-expanded="false">
