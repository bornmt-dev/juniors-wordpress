        ...
        <div class="<?php echo esc_attr($thumb_class)?>">
            <div class="detail-gallery detail-gallery-sticky">
                ...
                if(!empty($bzotech_video_product)) { ?>
                        <div class="video-product-detail-sticky">
                            <a class="video-product-detail-poup" href="<?php echo esc_url($bzotech_video_product);?>">
                                <i class="la-play la"></i>    
                                 <span><?php echo esc_html__('Watch video','bw-kidxtore');?></span>
                            </a>
                       </div>
                <?php } ?>
                <?php
