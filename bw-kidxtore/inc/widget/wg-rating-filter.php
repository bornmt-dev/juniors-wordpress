...
if(!class_exists('Bzotech_Rating_Filter') && class_exists("woocommerce"))
{
    class Bzotech_Rating_Filter extends WP_Widget {
        ...
        function __construct() {
            ...
            parent::__construct( false, esc_html__('BZOTECH Rating Filter','bw-kidxtore'),
                array( 'description' => esc_html__( 'Display a list of star ratings to filter products in your store.', 'bw-kidxtore' ), ));

            $this->default=array(
                'title'=>esc_html__('Rating','bw-kidxtore'),
            );
        }
