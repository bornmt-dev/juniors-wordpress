...
if(class_exists('WC_Widget')){
	class Bzotech_Widget_Price_Filter extends WC_Widget {
		...
		public function __construct() {
			...
			$this->widget_description = esc_html__( 'Display a slider to filter products in your store by price.', 'bw-kidxtore' );
			$this->widget_id          = 'woocommerce_price_filter';
			$this->widget_name        = esc_html__( 'BZOTECH Filter By Price', 'bw-kidxtore' );
			$this->settings           = array(
				'title'  => array(
					'type'  => 'text',
					'std'   => esc_html__( 'Filter by price', 'bw-kidxtore' ),
