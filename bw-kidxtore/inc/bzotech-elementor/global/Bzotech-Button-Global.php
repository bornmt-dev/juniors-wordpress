...
class Bzotech_Button_Global extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Button (Global)', 'bw-kidxtore' );
	}
...
/**
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options'   => [
					...
					'custom'		=> esc_html__( 'Style Custom', 'bw-kidxtore' ),
		...
		$this->start_controls_section(
			'section_button_flex',
			[
				'label' => esc_html__( 'Flex Container Control', 'bw-kidxtore' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Animation Hover', 'bw-kidxtore' ),
		...
		$this->add_control(
			'icon_color',
			[
				'label' => esc_html__( 'Color icon', 'bw-kidxtore' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				'name' => 'icon_border',
				'label' => esc_html__( 'Border type', 'bw-kidxtore' ),
				'selector' => '{{WRAPPER}} .icon-button-el',
			]
		);
		...
		$this->add_responsive_control(
			'size_icon_hover',
			[
				'label' => esc_html__( 'Size icon hover', 'bw-kidxtore' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em' ],
				'selectors' => [
		...
		$this->add_control(
			'icon_color_hover',
			[
				'label' => esc_html__( 'Color icon hover', 'bw-kidxtore' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_responsive_control(
			'margin_icon',
			[
				'label' => esc_html__( 'Margin icon', 'bw-kidxtore' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px' ],
				'selectors' => [
