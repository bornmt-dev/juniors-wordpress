	...
	public function login_form($redirect_to = '') {
        ...
        <div class="elbzotech-login-form popup-form active">
            <div class="form-header">
                <h2><?php esc_html_e( 'Sign In','bw-kidxtore' ); ?></h2>
            ...
            <form name="loginform" id="loginform" action="<?php echo esc_url( home_url( 'wp-login.php', 'login_post' ) ); ?>" method="post">
                ...
                if(class_exists('NextendSocialLogin', false)) {
                	echo '<div class="nextend-social-login"><h3 class="title20 font-medium text-center"><span>'.esc_html__('Or login With','bw-kidxtore').'</span></h3>';
	...
	public function register_form($redirect_to = '') {
        ...
        <div class="elbzotech-register-form popup-form">
            <div class="form-header">
                ...
                <div class="message login_error ms-error ms-default"><?php esc_html_e( 'The user name or email address is not correct.','bw-kidxtore' ); ?></div>
            ...
            <form name="registerform" id="registerform" action="<?php echo esc_url( home_url( 'wp-login.php?action=register', 'login_post' ) ); ?>" method="post" novalidate="novalidate">
                ...
                <div class="form-field">
                    <input placeholder="<?php esc_attr_e('Username','bw-kidxtore') ?>" type="text" name="user_login" id="user_loginr" class="input" value="" size="20" autocomplete="off"/>
                </div>
                <div class="form-field">
                    <input placeholder="<?php esc_attr_e('Email','bw-kidxtore') ?>" type="email" name="user_email" id="user_email" class="input" value="" size="25" autocomplete="off"/>
                </div>
                <?php if ( 'no' === get_option( 'woocommerce_registration_generate_password' ) ){ ?>
                    <div class="form-field password-input">
                        <input placeholder="<?php esc_attr_e( 'Password', 'bw-kidxtore' ); ?>" type="password" name="password" id="reg_passwordp" autocomplete="new-password" />
                    </div>
                <?php }?>
                <div class="extra-field">
                    <?php 
                ...
                <?php if ( 'no' != get_option( 'woocommerce_registration_generate_password' ) ){ ?>
                    <div id="reg_passmail">
                        <?php esc_html_e( 'Registration confirmation will be emailed to you.','bw-kidxtore' ); ?>
                    </div>
                <?php }?>
                <div class="submit"><input type="submit" name="wp-submit" class="elbzotech-bt-default elbzotech-bt-full" value="<?php esc_attr_e('Register','bw-kidxtore'); ?>" /></div>
	...
	public function lostpass_form($redirect_to = '') {
        ...
        <div class="elbzotech-lostpass-form popup-form">
            ...
            <form name="lostpasswordform" id="lostpasswordform" action="<?php echo esc_url( home_url( 'wp-login.php?action=lostpassword', 'login_post' ) ); ?>" method="post">
                <div class="form-field">
                    <input placeholder="<?php esc_attr_e( 'Username or Email Address','bw-kidxtore' ); ?>" type="text" name="user_login" id="user_loginlp" class="input" value="" size="20" autocomplete="off"/>
                </div>
                <div class="extra-field">
                    <?php do_action( 'lostpassword_form' ); ?>
                    <input type="hidden" name="redirect_to1" value="<?php echo esc_attr( $redirect_to ); ?>" />
                </div>
                <div class="submit"><input type="submit" name="wp-submit" class="elbzotech-bt-default elbzotech-bt-full" value="<?php esc_attr_e('Get New Password','bw-kidxtore'); ?>" /></div>
                <div class="desc note"><?php esc_html_e( 'A password will be e-mailed to you.','bw-kidxtore' ); ?></div>
            </form>
