...
class Bzotech_Posts_Global extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Posts (Global)', 'bw-kidxtore' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options'   => [
					'elbzotech-post-grid'		=> esc_html__( 'Default (Grid - list)', 'bw-kidxtore' ),
					'elbzotech-post-slider'		=> esc_html__( 'Slider', 'bw-kidxtore' ),
					'elbzotech-post-masonry'		=> esc_html__( 'Grid masonry (Home 7)', 'bw-kidxtore' ),
				],
			]
		);
