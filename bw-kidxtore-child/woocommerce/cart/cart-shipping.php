...
<tr class="gift-checkbox-row">
    <td colspan="2">
        <label for="gift-checkbox">
            <input type="checkbox" name="gift-receipt" id="gift-receipt" style="float: left;" />
            <span>I need a gift receipt</span><!-- <br>(Gift-wrapped upon delivery) -->
        </label>
    </td>
</tr>
			...
			<ul id="shipping_method" class="woocommerce-shipping-methods">
				...
				foreach ( $available_methods as $method ) :
					...
					<li <?php echo $li_style; ?>>
						...
						if ( $i === 1 ) {
							echo '<div class="shipping-method-note" style="font-size: 0.9em; color: #666; margin-top: 4px;">(Terms and Conditions apply)</div>';
						}
...
<tr class="woocommerce-cart-coupon-row">
    <td colspan="2">
        ...
        <div id="coupon-form-wrapper">
			<span>Got a promo code?</span>
            <form class="woocommerce-cart-coupon" method="post" style="display:flex; flex-wrap:wrap; gap:10px;">
                <input type="text" name="coupon_code" class="input-text" placeholder="<?php esc_attr_e( 'Enter code', 'woocommerce' ); ?>" id="coupon_code" value="" style="flex:1; min-width:180px;" />
