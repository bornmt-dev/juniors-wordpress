(function($){
    ...
    $(document).ready(function() {
        ...
        //     var count = 0;
        //     var link_redirect = $(this).find('input[name="redirect"]').val();
        ...
        //     user_data.push({
        //         name: 'security',
        //         value: $('.popup-form-account-ajax-nonce').val()
        //     });
        ...
        //                     // $(".elbzotech-register-form.popup-form .form-header").fadeOut();
        //                     // $(".elbzotech-register-form.popup-form #registerform").fadeOut();
        //                     // $(".elbzotech-register-form.popup-form .nav-form").fadeOut();
        //                     $(".elbzotech-register-form.popup-form").prepend("<h5 class='login_success_message' >Please check your registered email to set your password.</h5>");
        //                 }
        ...
        //             } else {
        //                 console.log("Error");
        //                 form.find('.message.login_error').html(response).show();
        //             }
        //         }
        //     });
        // });
