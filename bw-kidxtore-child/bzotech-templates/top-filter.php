...
<div class="main-top-filter">
    ...
    <h1 class="shop-title">Shop Toys Malta Online</h1>
    ...
    <div class="content-top-filter top-filter flex-wrapper justify_content-space-between align_items-center">
        ...
        <div class="main-top-filter__left flex-wrapper align_items-center">
            ...
            <div class="open-hide-filters open-hide-filters-desktop"><a href="#" data-textshow = "<?php echo esc_html__('Show Sidebar','bw-kidxtore'); ?>"  data-texthide = "<?php echo esc_html__('Hide Sidebar','bw-kidxtore'); ?>" class="dropdown-link"><span class="text"><?php echo esc_html__('Hide Sidebar','bw-kidxtore'); ?></span><?php echo bzotech_get_icon_svg('hide-filters'); ?></a></div>
            ...
            if($show_number == 'yes'):
                    ...
                    if(!isset($count_query)){
                        ...
                        $count_query ='';
                         ...
                         $count_query = '<span class="total-count">'.esc_html__(' of ','bw-kidxtore').$count_query.'</span>';
                    ...
                    <div class="show-by elbzotech-dropdown-box">
                        ...
                        <a href="#" class="dropdown-link"><span class="gray"><?php esc_html_e("Showing: ",'bw-kidxtore')?></span><span class="silver number"> <?php echo esc_html((int)$number)?></span><?php echo apply_filters('bzotech_output_content',$count_query); ?></a>
