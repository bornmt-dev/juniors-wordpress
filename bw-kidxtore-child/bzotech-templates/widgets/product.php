...
// Define the query to get only in-stock products
$args = array(
    'post_type'      => 'product',
    'posts_per_page' => 5, // adjust this as needed
    'meta_query'     => array(
        array(
            'key'     => '_stock_status',
            'value'   => 'instock',
...
if($query->have_posts()) {
    ...
    <div class="wg-product-slider">
        <div class="elbzotech-wrapper-slider display-swiper-navi-style1 ">
            <div class="elbzotech-swiper-slider swiper-container slider-wrap" data-items-custom="1:1" data-items="1" data-items-tablet="1" data-items-mobile="1"data-items-laptop="1" data-items-tablet-extra="1" data-items-mobile-extra ="1"  data-space="30" data-space-tablet="" data-space-mobile="" data-column="<?php echo esc_attr($number_row)?>" data-auto="" data-center="" data-loop="" data-speed="" data-navigation="" data-pagination=""> 
