	...
	<div class="elbzotech-search-form-wrap-global">
		...
		<div class="content-form-popup">
			...
			<form class="elbzotech-search-form-global" action="<?php echo esc_url( home_url( '/' ) ); ?>">
				...
				echo '<h3 class="text-center title34 font-regular font-title">'.esc_html__('Search For Products','bw-kidxtore').'</h3>'; ?>
		       	<div class="input-submit-form flex-wrapper align_items-stretch">
			        <input name="s" onblur="if (this.value=='') this.value = this.defaultValue" onfocus="if (this.value==this.defaultValue) this.value = ''" placeholder="<?php echo esc_attr($settings['placeholder']);?>" type="text" autocomplete="off">
