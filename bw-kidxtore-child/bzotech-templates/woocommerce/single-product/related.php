...
if ( $show_related == '1' && $related ) :
	...
	<div class="single-related-product">
		...
		<div class="elbzotech-wrapper-slider-product elbzotech-wrapper-slider
		<?php
		if ( ! empty( $slider_navigation ) ) {
			echo esc_attr( 'display-swiper-navi-' . $slider_navigation );}
		?>
	<?php
	if ( ! empty( $slider_pagination ) ) {
			echo esc_attr( 'display-swiper-pagination-' . $slider_pagination );}
	?>
	<?php
	if ( ! empty( $slider_scrollbar ) ) {
			echo esc_attr( 'display-swiper-scrollbar-' . $slider_scrollbar );}
	?>
">
